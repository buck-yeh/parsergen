...
public:
    ...
    // Nonvirtuials
    C_Output(const C_LexDfa &dfa, const C_Context &context);
...
C_Output::C_Output(const C_LexDfa &dfa, const C_Context &context):
    m_DFA(dfa),
    m_context(context)
{
    ...
    m_baseClass.assign(m_buxNS+"C_ScannerImpl<")
               ...
               .append(1, ',');
    const auto chType = getOptionString(m_context, "CHAR_TYPE", m_buxNS+"C_LexUTF32");
...
int main(int argc, const char *argv[])
{
    ...
    try
    {
        ...
        state =8;
        const std::string   path_cpp =path.string()+".cpp";
