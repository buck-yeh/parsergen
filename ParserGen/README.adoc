...
----
Output:
_the_very_last_ = ...(generated keywords & compound operators)... \| dec_num\|hex_num\|identifier\|c_char\|c_str\|spaces\|bracketed\|c_comment\|line_comment\|LexSymbol\|Nonterminal\|CompoundSymbol

| HEADERS_FOR_SCANNER_CPP | *tokens.txt* |
| %LOCALS_FOR_SCANNER_CPP | *tokens.txt* |
|===
