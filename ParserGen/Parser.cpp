...
{_reduce_14,	ZIP_TOKEN(NID_OperatorAssociation), 2},	// 20: <OperatorAssociation> ::= <OperatorAssociation> <Terminal>
...
{_reduce_25,	ZIP_TOKEN(NID_Production),  2},	// 35: <Production> ::= <Production> <Terminal>
...
{_reduce_32,	ZIP_TOKEN(NID_Terminal),    1},	// 43: <Terminal> ::= $LexSymbol
{_reduce_33,	ZIP_TOKEN(NID_Terminal),    1},	// 44: <Terminal> ::= $String
{_reduce_13,	ZIP_TOKEN(NID_Terminal),    1},	// 45: <Terminal> ::= $Num
{_reduce_34,	ZIP_TOKEN(NID_Terminal),    1},	// 46: <Terminal> ::= $Key
{_reduce_35,	ZIP_TOKEN(NID_Terminal),    1},	// 47: <Terminal> ::= $Operator
{_reduce_35,	ZIP_TOKEN(NID_Terminal),    1},	// 48: <Terminal> ::= <@operator>
{_reduce_36,	ZIP_TOKEN(NID_Terminal),    1},	// 49: <Terminal> ::= $Id
{_reduce_36,	ZIP_TOKEN(NID_Terminal),    1},	// 50: <Terminal> ::= <@keyword>
