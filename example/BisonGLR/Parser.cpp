...
public:
    ...
    void onError(void *userData, const bux::C_SourcePos &pos, const std::string &message) const override;
}   g_policy;
...
void C_ParserPolicy::onError(void *, const bux::C_SourcePos &pos, const std::string &message) const
{
...
C_GLRPOC::C_GLRPOC(): bux::GLR::C_Parser(g_policy)
{
}
